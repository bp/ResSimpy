...
EOS_KEYWORDS = ['WATER', 'OIL', 'GAS', 'SOLVENT', 'COMP', 'SURFACE_DENSITY', 'FORMULA_WEIGHT', 'DATABASE', 'PREOS', 
                'SRKEOS', 'CNAME', 'TCRIT', 'PCRIT', 'ZCRIT', 'ZMF', 'ACF', 'PRCORR', 'MW', 'SHIFT', 'OMEGAA',
                'OMEGAB', 'BIC', 'GCOND', 'PARACHOR']

WELLS_KEYWORDS = ['WELL_TYPE', 'OPEN', 'SHUT', 'RADIUS', 'DIAMETER', 'USE_HIST_TARG', 'CIJK_D', 'CIJKL_D', 'SKIN_FACTOR', 
                  'EFFECTIVE_KH', 'PRESSURE_RADIUS_R0', 'CONST_DRILL_DIR', 'BHPL', 'D_REF', 'Z_REF',
                  'INJECTION_ENTHALPY_P', 'INJECTION_ENTHALPY_T', 'ZINJ', 'MULTI_PI', 'GC_WEIGHT']
