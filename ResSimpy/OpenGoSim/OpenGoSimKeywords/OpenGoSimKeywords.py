...
#TO DO: GRDECL KEYWORDS E.G DX, PERMX, ZCORN ETC.
GRID_KEYWORDS = ['TYPE']
...
OUTPUT_KEYWORDS = ['MASS_BALANCE_FILE', 'PERIODIC TIMESTEP', 'ECLIPSE_FILE', 'PERIOD_SUM TIMESTEP', 'PERIOD_RST TIMESTEP',
...
#TO DO: ANALYTIC APPROACH KEYWORDS ALTHOUGH TABLES IS PROBABLY MOST COMMON COVERED BY BELOW
SAT_FUNCTIONS_KEYWORDS = ['TABLE', 'PRESSURE_UNITS', 'SWFN', 'SGFN', 'SGFN', 'SGSFN', 'SOF2', 'SOF3']

EOS_KEYWORDS = ['WATER', 'OIL', 'GAS', 'SOLVENT', 'COMP', 'SURFACE_DENSITY', 'FORMULA_WEIGHT', 'DATABASE', 'PREOS', 'SRKEOS', 
                'CNAME', 'TCRIT', 'PCRIT', 'ZCRIT', 'ZMF', 'ACF', 'PRCORR', 'MW', 'SHIFT', 'OMEGAA', 'OMEGAB', 'BIC', 'GCOND',
                'PARACHOR']
...
OPENGOSIM_KEYWORDS = GENERAL_KEYWORDS + SIMULATION_KEYWORDS + OUTPUT_KEYWORDS + MATERIAL_PROP_KEYWORDS + SAT_FUNCTIONS_KEYWORDS + \
                     EOS_KEYWORDS + WELLS_KEYWORDS + AQUIFER_KEYWORDS + EQUILIBRATION_KEYWORDS
