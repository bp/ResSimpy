...
class CompletionUnits(BaseUnitMapping):
    ...
    def i(self) -> str:
        ...
        return self.get_unit_from_attribute('i')

    @property
    def j(self) -> str:
        """Returns the unit for j."""
        return self.get_unit_from_attribute('j')

    @property
    def k(self) -> str:
        """Returns the unit for k."""
        return self.get_unit_from_attribute('k')

    @property
    def x(self) -> str:
        """Returns the unit for x."""
        return self.get_unit_from_attribute('x')

    @property
    def y(self) -> str:
        """Returns the unit for y."""
        return self.get_unit_from_attribute('y')
    ...
    def portype(self) -> str:
        ...
        return self.get_unit_from_attribute('portype')

    @property
    def facture_mult(self) -> str:
        """Returns the unit for facture_mult."""
        return self.get_unit_from_attribute('facture_mult')

    @property
    def sector(self) -> str:
        """Returns the unit for sector."""
        return self.get_unit_from_attribute('sector')

    @property
    def well_group(self) -> str:
        """Returns the unit for well_group."""
        return self.get_unit_from_attribute('well_group')

    @property
    def zone(self) -> str:
        """Returns the unit for zone."""
        return self.get_unit_from_attribute('zone')

    @property
    def angle_open_flow(self) -> str:
        """Returns the unit for angle_open_flow."""
        return self.get_unit_from_attribute('angle_open_flow')
    ...
    def flowsector(self) -> str:
        ...
        return self.get_unit_from_attribute('flowsector')

    @property
    def parent_node(self) -> str:
        """Returns the unit for parent_node."""
        return self.get_unit_from_attribute('parent_node')

    @property
    def mdcon(self) -> str:
        """Returns the unit for mdcon."""
        return self.get_unit_from_attribute('mdcon')

    @property
    def pressure_avg_pattern(self) -> str:
        """Returns the unit for pressure_avg_pattern."""
        return self.get_unit_from_attribute('pressure_avg_pattern')
