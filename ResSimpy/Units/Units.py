...
class AttributeUnitDimension:
    ...
    def get_unit(self, attribute_name: str, unit_system: UnitSystem, upper: bool = False) -> str:
        """Returns the unit variable for the given unit system."""
        unit = self.attribute_map[attribute_name].unit_system_enum_to_variable(unit_system=unit_system)
        if upper:
            unit = unit.upper()
        return unit
