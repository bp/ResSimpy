...
FCS_ALL_KEYWORDS = ['ADSORPTION', 'ALPHA', 'ALPHAF', 'AQUIFER', 'AQUIFER_FILES', 'CASE', 'CHOKE', 'COMPRESSOR',
                ...
                'RECURRENT_FILES', 'RELPM', 'RESERVOIR', 'RESTART', 'ROCK', 'ROCK_FILES', 'RUNCONTROL', 'RUN_SUNITS',
                'RUN_UNITS', 'SEPARATOR', 'STRUCTURED_GRID', 'SURFACE', 'TIME', 'TRACER_INIT', 'VALVE', 'VIP', 'WATER',
                'WELLS', 'X']
