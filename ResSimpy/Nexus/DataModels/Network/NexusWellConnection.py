...
Attributes:
    ...
    length (float): Length of an object (LENGTH)
    ...
    diameter (float): Diameter of an object (DIAM)
    inner_diameter (float): Inner diameter of an object (INNERDIAM)
    roughness (float): Surface roughness (ROUGHNESS)
