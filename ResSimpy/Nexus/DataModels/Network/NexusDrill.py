...
class NexusDrill(Drill):
    ...
    workover_time: Optional[int] = None
    ...
    def __init__(self, unit_system: Optional[UnitSystem] = None, name: Optional[str] = None, date: Optional[str] = None,
                 ...
                 drillsite: Optional[str] = None, drill_time: Optional[int] = None,
                 completion_time: Optional[int] = None, workover_time: Optional[int] = None, rigs: Optional[str] = None,
                 replacement: Optional[str] = None,
    ...
    def total_drill_time(self) -> float:
        ...
        return self.drill_time + self.completion_time
