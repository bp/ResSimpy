...
class NexusWellheads(Wellheads):
    ...
    def remove(self, obj_to_remove: DataObjectMixinDictType | UUID) -> None:
        ...
        Args:
            obj_to_remove (UUID | DataObjectMixinDictType): UUID of the wellhead to remove or a dictionary \
    ...
    def modify(self, obj_to_modify: DataObjectMixinDictType,
        ...
        Args:
            ...
            existing wellheads.
            new_properties (DataObjectMixinDictType): properties to switch to in the new wellhead
        """
        self.__parent_network.get_load_status()
