...
class NexusSeparatorMethods(Separator):
    ...
    def __init__(self, model_unit_system: UnitSystem,
        ...
        Args:
            ...
            assume_loaded (bool): If True, assumes that the separator methods have already been loaded.
    ...
    def keyword(self) -> str:
        """Return the keyword for separator methods."""
        return 'SEPARATOR'

    def add_method(self, method: DynamicProperty, new_file_name: str, create_new_file: bool = False) -> None:
        """Adds a new separator method to the collection.

        Args:
            method (DynamicProperty): The separator method to add.
