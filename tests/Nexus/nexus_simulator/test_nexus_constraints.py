...
def test_load_constraints(mocker, globalFixture, file_contents, expected_content):
    # Arrange
...
def test_constraint_ids(mocker, globalFixture, file_contents, object_locations):
    # Arrange
