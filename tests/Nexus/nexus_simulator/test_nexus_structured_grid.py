...
def test_load_structured_grid_file_basic_properties(mocker, globalFixture, structured_grid_file_contents,
...
def test_load_structured_grid_file_basic_properties_nested_includes(mocker, globalFixture):
...
def test_load_structured_grid_file_dict_basic_properties(mocker, globalFixture, structured_grid_file_contents,
...
def test_load_structured_grid_file_sw(mocker, globalFixture, structured_grid_file_contents,
...
def test_load_structured_grid_file_k_values(mocker, globalFixture, structured_grid_file_contents, expected_kx_value,
...
def test_save_structured_grid_values(mocker, globalFixture, new_porosity, new_sw, new_netgrs, new_kx, new_ky, new_kz):
...
def test_view_command(mocker, globalFixture, structured_grid_file_contents, expected_text):
...
def test_get_abs_structured_grid_path(mocker, globalFixture, fcs_file, expected_root, expected_extracted_path):
    # Arrange
...
def test_load_faults(mocker, globalFixture, structured_grid_file_contents, expected_results):
...
def test_included_fault_tables(mocker, globalFixture):
    # Arrange
    fcs_path = 'testpath1/nexus_run.fcs'
    fcs_file = "DESC test fcs file\nDATEFORMAT MM/DD/YYYY\nGRID_FILES\n\tSTRUCTURED_GRID test_structured_grid.dat"
    structured_grid_path = os.path.join('testpath1', 'test_structured_grid.dat')
