...
"""
    ...
    exp_welcon_1 = NexusWellConnection(welcon_props_1, date_format=DateFormat.MM_DD_YYYY, is_activated=False,
                                       start_date=start_date)
    exp_welcon_2 = NexusWellConnection(welcon_props_2, date_format=DateFormat.MM_DD_YYYY, is_activated=False,
                                       start_date=start_date)
