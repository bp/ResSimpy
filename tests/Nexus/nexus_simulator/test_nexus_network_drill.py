...
def test_load_nexus_drills_load_method(mocker):
    # Arrange
    start_date = '15/01/2025'
    surface_file_contents = """
    TIME 25/07/2026
...
ENDDRILL
    ...
    drills_obj = NexusDrills(parent_network=network_object)
    ...
    # Act
    # Load the file
    drills_obj.load(default_units=UnitSystem.ENGLISH, start_date=start_date, surface_file=surface_file)
    result = drills_obj.get_all()
...
def test_load_nexus_drill_site_load_method(mocker):
    # Arrange
    start_date = '15/01/2025'
    surface_file_contents = """
    TIME 25/07/2026
...
ENDDRILLSITE
    ...
    network_object = NexusNetwork(model=dummy_model, assume_loaded=True)
    drillsites_obj = NexusDrillSites(parent_network=network_object)
    ...
    # Act
    # Load the file
    drillsites_obj.load(default_units=UnitSystem.ENGLISH, start_date=start_date, surface_file=surface_file)
    result = drillsites_obj.get_all()
