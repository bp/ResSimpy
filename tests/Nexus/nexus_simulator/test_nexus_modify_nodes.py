...
def test_remove_node(mocker, fixture_for_osstat_pathlib, file_contents, expected_file_contents, node_to_remove, expected_nodes,
...
'hitting end of file'])
def test_add_node(mocker, fixture_for_osstat_pathlib, file_contents, expected_file_contents, node_to_add, expected_nodes,
                  expected_number_writes):
    # Arrange
    fcs_file_contents = '''
        RUN_UNITS ENGLISH
...
def test_modify_node(mocker, fixture_for_osstat_pathlib, file_contents, expected_file_contents, node_to_modify, modified_properties, expected_nodes,
                     expected_number_writes):
    # Arrange
    fcs_file_contents = '''
        RUN_UNITS ENGLISH
