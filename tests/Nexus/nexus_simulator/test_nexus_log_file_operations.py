...
def test_get_simulation_progress(mocker, globalFixture, log_file_contents, times, expected_progress):
...
def test_get_status_running(mocker, globalFixture):
...
def test_get_status_finished(mocker, globalFixture, log_file_contents, errors, warnings):
...
def test_get_base_case_run_time(mocker, globalFixture, log_file_contents, run_time):
...
def test_get_simulation_start_time(mocker, globalFixture, log_file_contents, start_time):
...
def test_get_simulation_end_time(mocker, globalFixture, log_file_contents, end_time):
...
def test_get_simulation_start_end_time(mocker, globalFixture, log_file_contents, expected_start_time, expected_end_time):
    """Test the get end time functionality"""
    # Arrange
    fcs_file = f"RUNCONTROL /run_control/path\nDATEFORMAT DD/MM/YYYY\n"
