...
def test_load_run_control_file_times_in_include_file(mocker, globalFixture, date_format, expected_date_format,
...
def test_load_run_control_invalid_times(mocker, globalFixture, date_format, run_control_contents, include_file_contents):
...
def test_modify_times(mocker, globalFixture, date_format, expected_date_format,
...
def test_modify_times_invalid_date(mocker, globalFixture, date_format, expected_date_format,
                                   run_control_contents, include_file_contents, new_times, operation, expected_times):
...
def test_runcontrol_no_start_time(mocker, globalFixture):
    # Arrange
