...
def test_add_connection(mocker, globalFixture, file_contents, expected_file_contents, connection_to_add, expected_connections, expected_number_writes):
    # Arrange
    fcs_file_contents = '''
        RUN_UNITS ENGLISH
...
def test_remove_connection(mocker, globalFixture, file_contents, expected_file_contents, connection_to_remove, expected_connection,
...
def test_modify_connections(mocker, globalFixture, file_contents, expected_file_contents, obj_to_modify, modified_properties, expected_objs,
                     expected_number_writes):
    # Arrange
    fcs_file_contents = '''
        RUN_UNITS ENGLISH
