...
def test_get_array_functions():
    input_grid_file_lines = ['', '', '', '', 'MAPBINARY', '', 'MAPVDB', '', 'MAPOUT ALL', '', '', '', '', '', 'NOLIST', '',
                         ...
                         'KZ MULT', '', '0.1  KX', '', '', 'POROSITY CON', '', '0.2', '', '', 'NETGRS CON', '', '0.8',
                         '', '', 'SWL CON', '', '0.26', '', '', 'SWR CON', '', '0.30', '', '', 'SWRO CON', '', '0.8',
                         '', '', 'SWU CON', '', '1.0', '', '', 'IEQUIL CON', '', '1', '', '', '', '', '', 'WORKA3 CON',
                         '', '0.3', '', '', '', 'FUNCTION', '', 'BLOCKS   1 30  1 30  1 1', '', 'ANALYT POLYN 1 0', '',
                         'blah', '', 'WORKA3 OUTPUT SW', '', '', '', 'FUNCTION IEQUIL', '', '1', '',
                         'RANGE OUTPUT 0.1 0.3', 'ANALYT POLYN 1 0', '', 'WORKA3 OUTPUT SWL', '', '', '', 'bugger line',
                         ...
                         'WORKA3 ky OUTPUT KX',
                         'FUNCTION', 'ANALYT min', 'KX KY OUTPUT KY', 'FUNCTION', 'ANALYT  max', ' KX KY OUTPUT KX', 'bugger'
                             ]
    ...
    expected_functions = [['FUNCTION', 'ANALYT MULT', 'WORKA3 KX OUTPUT KX'],
        ['FUNCTION IREGION', '8', 'ANALYT POLYN a0 a1 a2', 'POROSITY OUTPUT POROSITY'], ['FUNCTION IREGION', '8 9 10', 'ANALYT     log', 'WORKA3    OUTPUT  KX'], ['FUNCTION', 'ANALYT log10', 'WORKA3 OUTPUT KX'],
        ['FUNCTION  IREGION', '8 9 10', 'ANALYT polyn 1.4 1.3 1.2 1.1 1.0', 'POROSITY output POROSITY'],
        ['FUNCTION', 'BLOCKs 1 30 1   30 1 5', 'ANALYT Abs', 'WORKA3 OUTPUT KX'], ['FUNCTION', 'ANALYT EXP', 'KX OUTPUT KX'], ['FUNCTION', 'ANALYT EXp10', ' KX OUTPUT KX'],
        ['FUNCTION', 'ANALYT sqrt', 'WORKA3 OUTPUT KX'], ['FUNCTION', 'ANALYT GE 1000 500', 'KX OUTPUT KX'], ['FUNCTION', 'ANALYT LE 500 1000', ' KY OUTPUT KX'],
        ['FUNCTION', 'ANALYT    add ', 'WORKA3 ky OUTPUT KX'], ['FUNCTION', 'ANALYT subt', 'KX KY OUTPUT Kz'], ['FUNCTION', 'ANALYT DIV', ' KX KY OUTPUT Kz'],
        ['FUNCTION IREGION', '8 9 10', ' GRID ROOT', 'BLOCKS 1 20 1  40 1 10', 'RANGE  INPUT 1 2  1000 2000', 'RANGE output 2000 3000' ,'ANALYT    mult ', 'WORKA3 ky OUTPUT KX'],
