...
def test_hyd_method_hash():
    ...
    hyd_obj = NexusPVTMethod(file=hyd_file, input_number=1, model_unit_system=UnitSystem.ENGLISH,
                                properties=hydraulic_props)
    hyd_obj_2 = NexusPVTMethod(file=hyd_file, input_number=2, model_unit_system=UnitSystem.ENGLISH,
                                properties=hydraulic_props)
    hyd_obj_3 = NexusPVTMethod(file=hyd_file, input_number=2, model_unit_system=UnitSystem.ENGLISH,
