...
def test_load_basic_wellspec(mocker, globalFixture, file_contents, expected_name):
    # Arrange
...
def test_load_wells_multiple_wells(mocker, globalFixture):
    # Arrange
    start_date = '01/01/2023'
...
def test_load_wells_multiple_wells_multiple_dates(mocker, globalFixture):
    # Arrange
    start_date = '01/01/2023'
    date_format = 'DD/MM/YYYY'
...
def test_load_wells_all_columns_present_structured_grid(mocker, globalFixture):
    # Arrange
    start_date = '01/01/2023'
    date_format = 'DD/MM/YYYY'
...
def test_load_wells_all_columns_unstructured_grid(mocker, globalFixture):
    # Arrange
    start_date = '01/01/2023'
    date_format = 'DD/MM/YYYY'
...
def test_load_wells_rel_perm_tables(mocker, globalFixture):
    # Arrange
    start_date = '01/01/2023'
    date_format = 'DD/MM/YYYY'
...
def test_load_wells_na_values_converted_to_none(mocker, globalFixture):
    # Arrange
    start_date = '01/01/2023'
    date_format = 'DD/MM/YYYY'
...
def test_correct_units_loaded(mocker, globalFixture, file_contents, expected_units):
    # Arrange
